\section{Auswahl der Technologie - Client [BG]}
...
\section{Technologien zur Entwicklung des Frontends}
...
\subsubsection{Das Ökosystem von Angular}
...
\subsection{Angular Materials [DH]}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{pics/Themes.png}
...
\end{lstlisting}
\cite{ReactWithoutJSX} \pagebreak
...
Relationale Datenbanken verfolgen das ACID-Prinzip.
\newpage ACID steht für: 
...
\subsubsection{Steuerung der Hardware [SK]}
